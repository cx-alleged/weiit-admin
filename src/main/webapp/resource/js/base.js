...
function FullScreenShow(msg) {
    ...
    if (loadingCount < 1) {
    	loadingTime = setTimeout(function () {
            $("#div_loadingImg").append("<div id='loadingPage_bg' class='loadingPage_bg1'></div><div id='loadingPage'><h3>&nbsp;</h3></div><br><div style='color:white;width:200px;top:39%;z-index:10000;position:absolute;left:43%;'>" + msg + "</div>");
...
function commonExportList(formId,exportClassName,exportMethodName,exporTexcelName,exportTitles,exportFields,fileType){
	...
	var url=basePath+"/center/publics/excel/export?"+$("#"+formId).serialize();
...
function openSource(id){
	//图片素材地址
	var url=basePath+"/center/file/picture/source";
...
function openProduct(id){
	var url=basePath+"/center/publics/publics/productGridList";
