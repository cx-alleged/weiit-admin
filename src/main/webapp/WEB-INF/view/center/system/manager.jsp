						...
						<ul class="breadcrumb-elements">
							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu dropdown-menu-right">
									...
									<li class="checkbox"><label><input type="checkbox" class="styled" checked="checked" value="manager_column_description"> 描述说明</label></li>
...
function submitEditPass(){
	if(document.getElementById("editPass").password.value.length<5){
		 new PNotify({title: '提示操作',text: '密码不足五位',addclass: 'bg-info'});
	}else{
